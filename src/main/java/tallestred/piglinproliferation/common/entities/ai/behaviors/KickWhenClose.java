        ...
        return BehaviorBuilder.create(
                p_260278_ -> p_260278_.group(
                        ...
                        .apply(p_260278_, (p_260206_, p_259953_, p_259993_, p_259209_) -> (p_259617_, mob, p_259374_) -> {
                            ...
                            if (livingentity.closerThan(mob, (double) p_259782_) && p_260278_.<NearestVisibleLivingEntities>get(p_259209_).contains(livingentity) && ((PiglinTraveler) mob).getKickCoolDown() <= 0) {
                                p_259953_.set(new EntityTracker(livingentity, true));
                                if (mob.doHurtTarget(livingentity)) {
                                    ((PiglinTraveler) mob).setKickTicks(10);
                                ...
                                ((PiglinTraveler) mob).setKickCoolDown(100);
