...
public class PiglinTraveler extends Piglin {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pReason, @Nullable SpawnGroupData pSpawnData, @Nullable CompoundTag pDataTag) {
        ...
        this.setItemSlot(EquipmentSlot.MAINHAND, (double) this.random.nextFloat() < PPConfig.COMMON.crossbowChanceTraveler.get().floatValue() ? new ItemStack(Items.CROSSBOW) : new ItemStack(Items.GOLDEN_SWORD));
    ...
    public static boolean checkTravelerSpawnRules(EntityType<PiglinTraveler> entityType, LevelAccessor p_219199_, MobSpawnType p_219200_, BlockPos p_219201_, RandomSource p_219202_) {
    ...
    protected void playConvertedSound() {
        this.playSound(PPSounds.TRAVELER_CONVERTED.get(), this.getSoundVolume(), this.getVoicePitch() / 0.10F);
    }
