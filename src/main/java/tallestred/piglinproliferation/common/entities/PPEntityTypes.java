...
public class PPEntityTypes {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<PiglinTraveller>> PIGLIN_TRAVELLER = ENTITIES.register("piglin_traveller", () -> EntityType.Builder.of(PiglinTraveller::new, MobCategory.MONSTER).sized(0.6F, 1.95F).clientTrackingRange(8).setShouldReceiveVelocityUpdates(true).build(PiglinProliferation.MODID + "piglin_traveller"));
}
