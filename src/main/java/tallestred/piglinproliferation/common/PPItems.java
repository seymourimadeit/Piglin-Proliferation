...
public class PPItems {
    ...
    public static final RegistryObject<Item> PIGLIN_HEAD_ITEM = ITEMS.register("piglin_head", () -> new StandingAndWallBlockItem(PPBlocks.PIGLIN_HEAD.get(), PPBlocks.PIGLIN_HEAD_WALL.get(), new Item.Properties().rarity(Rarity.UNCOMMON), Direction.DOWN));
