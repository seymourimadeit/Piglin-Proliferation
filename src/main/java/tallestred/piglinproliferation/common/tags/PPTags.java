...
public class PPTags {
    ...
    public static final TagKey<Biome> WITHOUT_TRAVELER_SPAWNS = TagKey.create(Registries.BIOME, new ResourceLocation(PiglinProliferation.MODID, "without_traveler_spawns"));
}