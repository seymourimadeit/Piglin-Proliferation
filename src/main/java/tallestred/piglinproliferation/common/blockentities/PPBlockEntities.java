...
public class PPBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<FireRingBlockEntity>> FIRE_RING = BLOCK_ENTITIES.register("fire_ring", () -> BlockEntityType.Builder.of(FireRingBlockEntity::new, PPBlocks.BLACKSTONE_FIRE_RING.get()/*and other slater*/).build(null));
}
