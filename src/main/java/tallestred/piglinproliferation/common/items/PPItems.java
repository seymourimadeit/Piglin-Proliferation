...
public class PPItems {
    ...
    public static final RegistryObject<TravelersCompassItem> TRAVELERS_COMPASS = ITEMS.register("travelers_compass", () -> new TravelersCompassItem(new Item.Properties()));
    ...
    public static final RegistryObject<ForgeSpawnEggItem> PIGLIN_TRAVELER_SPAWN_EGG = ITEMS.register("piglin_traveler_spawn_egg", () -> new ForgeSpawnEggItem(PPEntityTypes.PIGLIN_TRAVELER, 3848107, 16380836, (new Item.Properties())));
    ...
    public static final RegistryObject<Item> PIGLIN_TRAVELER_HEAD_ITEM = ITEMS.register("piglin_traveler_head", () -> new StandingAndWallBlockItem(PPBlocks.PIGLIN_TRAVELER_HEAD.get(), PPBlocks.PIGLIN_TRAVELER_HEAD_WALL.get(), new Item.Properties().rarity(Rarity.UNCOMMON), Direction.DOWN));
