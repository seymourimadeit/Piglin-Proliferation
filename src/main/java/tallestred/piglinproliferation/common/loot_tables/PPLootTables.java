...
public class PPLootTables {
    ...
    public static final RegistryObject<LootItemFunctionType> TRAVELLERS_COMPASS_LOCATION = LOOT_ITEM_FUNCTION_TYPES.register("travellers_compass_location", () ->  new LootItemFunctionType(new TravellerCompassLocateFunction.Serializer()));
}
