...
public class PPRenderSetupEvents {
    ...
    public static void registerSkullModels(EntityRenderersEvent.CreateSkullModels event) {
        event.registerSkullModel(PiglinSkullBlock.Types.PIGLIN_BRUTE, new PiglinHeadEntityModel(event.getEntityModelSet().bakeLayer(PPRenderSetupEvents.PIGLIN_SKULL)));
        event.registerSkullModel(PiglinSkullBlock.Types.ZOMBIFIED_PIGLIN, new PiglinHeadEntityModel(event.getEntityModelSet().bakeLayer(PPRenderSetupEvents.PIGLIN_SKULL)));
        event.registerSkullModel(PiglinSkullBlock.Types.PIGLIN_ALCHEMIST, new PiglinHeadEntityModel(event.getEntityModelSet().bakeLayer(PPRenderSetupEvents.PIGLIN_ALCHEMIST_SKULL)));
        event.registerSkullModel(PiglinSkullBlock.Types.PIGLIN_TRAVELLER, new PiglinHeadEntityModel(event.getEntityModelSet().bakeLayer(PPRenderSetupEvents.PIGLIN_TRAVELLER_SKULL)));
    }
