...
public class PPRenderSetupEvents {
    ...
    public static void registerSkullModels(EntityRenderersEvent.CreateSkullModels event) {
        ...
        event.registerSkullModel(PiglinSkullBlock.Types.PIGLIN_TRAVELER, new PiglinHeadEntityModel(event.getEntityModelSet().bakeLayer(PPRenderSetupEvents.PIGLIN_TRAVELER_SKULL)));
    }
