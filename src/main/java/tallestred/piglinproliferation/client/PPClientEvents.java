...
public class PPClientEvents {
    ...
    public static void onRenderHand(RenderHandEvent event) {
        ...
        Minecraft mc = Minecraft.getInstance();
        LocalPlayer player = mc.player;
        if (player != null && stack.getItem() instanceof BucklerItem && (player.isUsingItem() && player.getUseItem() == stack || BucklerItem.getChargeTicks(stack) > 0 && BucklerItem.isReady(stack))) {
