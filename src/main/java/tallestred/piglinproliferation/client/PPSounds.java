...
public class PPSounds {
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> CRITICAL_APPLY = SOUNDS.register("entity.critical_aura.apply", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(PiglinProliferation.MODID, "entity.critical_aura.apply")));
