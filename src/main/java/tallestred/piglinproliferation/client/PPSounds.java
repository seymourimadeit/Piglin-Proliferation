...
public class PPSounds {
    ...
    public static final RegistryObject<SoundEvent> CRITICAL_ACTIVATE = SOUNDS.register("entity.critical_aura.activate", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(PiglinProliferation.MODID, "entity.critical_aura.activate")));
    public static final RegistryObject<SoundEvent> CRITICAL_APPLY = SOUNDS.register("entity.critical_aura.apply", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(PiglinProliferation.MODID, "entity.critical_aura.apply")));
    public static final RegistryObject<SoundEvent> CRITICAL_DEACTIVATE = SOUNDS.register("entity.critical_aura.deactivate", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(PiglinProliferation.MODID, "entity.critical_aura.deactivate")));
