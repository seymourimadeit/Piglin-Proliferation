...
public class PPSounds {
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> CRITICAL_ACTIVATE = SOUNDS.register("entity.criticalcharge.activate", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(PiglinProliferation.MODID, "entity.criticalcharge.activate")));
    public static final DeferredHolder<SoundEvent, SoundEvent> CRITICAL_DEACTIVATE = SOUNDS.register("entity.criticalcharge.deactivate", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(PiglinProliferation.MODID, "entity.criticalcharge.deactivate")));
