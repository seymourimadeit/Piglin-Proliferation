...
public class PPConfig {
    ...
    public static class CommonConfig {
        ...
        public final ForgeConfigSpec.IntValue alchemistWeight;
        ...
        public CommonConfig(ForgeConfigSpec.Builder builder) {
            ...
            alchemistWeightInBastions = builder.comment("Weight is calculated by dividing the current value by the sum of all weights combined.",
                    ...
                    "(Due to this, regular piglins have a spawn rate of 28% aswell, and brutes have a spawn rate of 7% spawn rate, changed values will have to account for this).").defineInRange("Alchemist spawnrate weight in bastions", 4, Integer.MIN_VALUE, Integer.MAX_VALUE);
            ...
            alchemistMaxSpawnCount = builder.defineInRange("Maximium spawn count for alchemists", 6, Integer.MIN_VALUE, Integer.MAX_VALUE);
